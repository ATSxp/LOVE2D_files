...
walls.distance = math.random(100, 130) -- a small distance between the pipes
...
function walls:new()
    ...
    if self.spawn_timer <= 0 then
        ...
        table.insert(self.blocks, {
            ...
            y1 = math.random(- 400 + 80, - 80), -- y axis for the top pipe
...
function walls:update(dt)
    ...
    self.spawn_timer = self.spawn_timer - 50 * dt
